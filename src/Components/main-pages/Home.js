  ...
  return (
    <div>
      ...
      <div className="Main-Content">
        ...
        <p className='Main-Paragraph'> 
          This site contains a variety of information. The <a href="Projects">projects section</a> of the site includes detailed examples of projects I have undertaken and provides links to where these can be viewed.
        </p>
      </div>
        <ContactDetails />
    </div>
