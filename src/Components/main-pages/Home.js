...
const Home = () => (
  <div>
    ...
    <div className="Main-Content">
      <p className='Main-Paragraph'> 
        I am a final year student at <a href="https://port.ac.uk" rel="noreferrer">The University of Portsmouth</a>, where I study <a href="https://www.port.ac.uk/study/courses/bsc-hons-cyber-security-and-forensic-computing" rel="noreferrer">Cyber Security and Forensic Computing</a>. I also work as a Software Developer at a multi-national defence company. 
      </p>
      <p className='Main-Paragraph'> 
        As a software developer my primary interests are in web development, specifically JavaScript and React. I am familiar with a wide array of web development technologies, such as React, Redux, Jest, jQuery and ASP.NET. Along side this, I have also extended my knowledge to cover the basics of a number of other languages. These include C, Python, Java, VB.NET and SQL.
      </p>
      <p className='Main-Paragraph'> 
      ...
      <p className='Main-Paragraph'> 
        This site contains a variety of information. The projects section of the site includes detailed examples of projects I have undertaken and provides links to where these can be viewed.
      </p>
    </div>
    <ContactDetails />
  </div>
